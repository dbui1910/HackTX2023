...
def call_the_VT(website):
    ...
    if response.status_code == 200:
        ...
        if 'positives' in json_response:
            ...
            domain.compareDomain(r'C:\Users\Analisa Rojas\Desktop\Hackathons\HackTX\firstLine\badDomain.json', r'C:\Users\Analisa Rojas\Desktop\Hackathons\HackTX\firstLine\goodDomain.json')
